...
const HOUSES = [
  { id: 1, name: '청파동 빌라', addr: '청파로47길 22', type: 'rent',
    ...
    tag: '햇빛 좋음', note: '엘리베이터 있음, 옥상 사용가능', photoHue: 32, commute: 32, commuteSchool: 41, dir: '남향', elevator: true, parking: false, full: true },
  { id: 2, name: '후암동 오피스텔', addr: '후암로 88', type: 'rent',
    ...
    tag: '역세권', note: '서울역 도보 7분', photoHue: 200, commute: 24, commuteSchool: 33, dir: '동향', elevator: true, parking: false, full: true },
  { id: 3, name: '서계동 신축빌라', addr: '서계로 12', type: 'jeonse',
    ...
    tag: '신축', note: '24년 준공, 빌트인 풀옵션', photoHue: 145, commute: 38, commuteSchool: 47, dir: '남향', elevator: false, parking: true, full: true },
  { id: 4, name: '용산동2가 투룸', addr: '두텁바위로 60', type: 'jeonse',
    ...
    tag: '넓음', note: '주차장 있음, 분리형 투룸', photoHue: 18, commute: 41, commuteSchool: 52, dir: '남서향', elevator: true, parking: true, full: false },
  { id: 5, name: '갈월동 단독', addr: '청파로 200', type: 'rent',
    ...
    tag: '수압 약함', note: '수압 확인 필요, 채광은 OK', photoHue: 280, commute: 29, commuteSchool: 38, dir: '북향', elevator: false, parking: false, full: false },
  { id: 6, name: '남영동 리모델링', addr: '한강대로77길', type: 'rent',
    ...
    tag: '리모델링', note: '23년 전체 리모델링', photoHue: 50, commute: 26, commuteSchool: 44, dir: '남동향', elevator: false, parking: true, full: true },
  { id: 7, name: '효창동 빌라', addr: '효창원로 33', type: 'jeonse',
    ...
    tag: '곰팡이 흔적', note: '북향 곰팡이 흔적 확인', photoHue: 220, commute: 35, commuteSchool: 29, dir: '북향', elevator: false, parking: false, full: false },
];
...
function Icon({ name, size = 16, color = 'currentColor', stroke = 1.6 }) {
  ...
  switch (name) {
    ...
    case 'tri-up': return <svg viewBox="0 0 20 20" style={s}><path d="M10 5l5 8H5l5-8z" fill={color} stroke="none"/></svg>;
    case 'tri-down': return <svg viewBox="0 0 20 20" style={s}><path d="M10 15l5-8H5l5 8z" fill={color} stroke="none"/></svg>;
    default: return null;
  }
}
...
// 항목별 실제 값 어휘 (3=좋음, 2=보통, 1=나쁨 — 색은 동일, 라벨만 항목 의미에 맞게)
const CL_LABELS = {
  sun:   { 3: '잘 듦', 2: '보통', 1: '잘 안 듦' },
  water: { 3: '강함',  2: '보통', 1: '약함' },
  mold:  { 3: '없음',  2: '약간', 1: '있음' },
  noise: { 3: '좋음',  2: '보통', 1: '나쁨' },
  vent:  { 3: '잘 됨', 2: '보통', 1: '안 됨' },
};
const clColor = (v) => v >= 3 ? PH.green : v === 2 ? PH.amber : PH.red;
const clLabel = (v) => v >= 3 ? '좋음' : v === 2 ? '보통' : '나쁨';
const clValue = (key, v) => (CL_LABELS[key] && CL_LABELS[key][v]) || clLabel(v);
...
Object.assign(window, {
  ...
  Icon, CL_META, CL_LABELS, clColor, clLabel, clValue, Screen,
